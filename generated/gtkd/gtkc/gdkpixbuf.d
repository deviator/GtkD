...
shared static this()
{
	...
	Linker.link(gdk_pixbuf_get_type, "gdk_pixbuf_get_type", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new, "gdk_pixbuf_new", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_bytes, "gdk_pixbuf_new_from_bytes", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_data, "gdk_pixbuf_new_from_data", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_file, "gdk_pixbuf_new_from_file", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_file_at_scale, "gdk_pixbuf_new_from_file_at_scale", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_file_at_size, "gdk_pixbuf_new_from_file_at_size", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_inline, "gdk_pixbuf_new_from_inline", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_resource, "gdk_pixbuf_new_from_resource", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_resource_at_scale, "gdk_pixbuf_new_from_resource_at_scale", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_stream, "gdk_pixbuf_new_from_stream", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_stream_at_scale, "gdk_pixbuf_new_from_stream_at_scale", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_stream_finish, "gdk_pixbuf_new_from_stream_finish", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_from_xpm_data, "gdk_pixbuf_new_from_xpm_data", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_add_alpha, "gdk_pixbuf_add_alpha", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_apply_embedded_orientation, "gdk_pixbuf_apply_embedded_orientation", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_composite, "gdk_pixbuf_composite", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_composite_color, "gdk_pixbuf_composite_color", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_get_byte_length, "gdk_pixbuf_get_byte_length", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_get_colorspace, "gdk_pixbuf_get_colorspace", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_get_has_alpha, "gdk_pixbuf_get_has_alpha", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_get_width, "gdk_pixbuf_get_width", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_new_subpixbuf, "gdk_pixbuf_new_subpixbuf", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_save_to_buffer, "gdk_pixbuf_save_to_buffer", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_save_to_bufferv, "gdk_pixbuf_save_to_bufferv", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	Linker.link(gdk_pixbuf_save_to_callback, "gdk_pixbuf_save_to_callback", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_animation_get_type, "gdk_pixbuf_animation_get_type", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_animation_iter_get_type, "gdk_pixbuf_animation_iter_get_type", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_format_get_type, "gdk_pixbuf_format_get_type", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_loader_get_type, "gdk_pixbuf_loader_get_type", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_simple_anim_get_type, "gdk_pixbuf_simple_anim_get_type", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
	...
	Linker.link(gdk_pixbuf_simple_anim_iter_get_type, "gdk_pixbuf_simple_anim_iter_get_type", LIBRARY.GDKPIXBUF, LIBRARY.GDKPIXBUF);
